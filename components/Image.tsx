...
const Figure = styled.figure<{ $margin: number; children?: React.ReactNode }>`
  display: block;
  text-align: center;
...
const Main = styled.div<{ $width: number; children?: React.ReactNode }>`
  margin: 0 auto;
  max-width: 100%;
...
const ImageWrapper = styled.div<{ $aspectRatio: CSS.Properties['paddingBottom']; children?: React.ReactNode }>`
  position: relative;
