...
const companies = [
  ...
  },
  {
    ...
    name: 'Zillow',
    logo: ZillowLogo, // need to add to companylogos
    style: {},
    projects: {
      zillow: {
        title: 'Zillow',
  ...
  {
    key: 'https://www.giphy.com/',
    similarWebGlobalRank: 941,
    name: 'Giphy',
    logo: GiphyLogo, // need to add to companylogos
    style: {},
    projects: {
      giphy: {
        title: 'Giphy',
  ...
  {
    key: 'https://www.gizmodo.com/',
    similarWebGlobalRank: 3189,
    name: 'Gizmodo',
    logo: GizmodoLogo, // need to add to companylogos
    style: {},
    projects: {
      gizmodo: {
        title: 'Gizmodo',
