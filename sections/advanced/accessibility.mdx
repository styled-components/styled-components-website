...
The plugin mirrors `eslint-plugin-jsx-a11y` for styled components, including rules like `alt-text`, `aria-role`, `click-events-have-key-events`, and `label-has-associated-control`.
