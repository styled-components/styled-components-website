...
This plugin ensures styled components produce consistent output on the client and server. Without it, server-side rendering will trigger React HTML attribute mismatch warnings during rehydration.
