...
<Table head={['Values', 'Description']}>
  ...
  <Row>
    ...
    <Column>
      ...
      existing component props. The factory accepts an optional second
      argument, <Code>ast</Code>, for reading style declarations or theme
      tokens — see <a href="/docs/basics#bridging-styles-into-props--v7">Bridging styles into props</a>.
    </Column>
  </Row>
</Table>
