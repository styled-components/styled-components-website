...
> The `"innerRef"` prop was removed in styled-components v4 in favor of the [`forwardRef` API](https://react.dev/reference/react/forwardRef). Just use the normal `ref` prop instead.
