...
> For a feature-by-feature comparison of what works in v6 vs v7 on web and React Native, see the
> [CSS Compatibility matrix](/docs/compatibility).

```react
const Example = styled.div`
  /* vendor prefixing is disabled by default in v6; opt in via <StyleSheetManager enableVendorPrefixes> */
  padding: 2em 1em;
