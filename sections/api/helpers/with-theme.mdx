...
> **Prefer `useTheme` hook:** For function components, the [`useTheme`](/docs/api#usetheme) hook provides a simpler API. `withTheme` is primarily useful for class components.
