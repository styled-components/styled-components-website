...
Returns a Keyframes model, to be used in your animation declarations. Call `getName()` on the result if you need the animation name as a string (e.g., for use in `animation-name` outside a template literal).
