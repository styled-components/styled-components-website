...
> **Historical note:** This migration guide is for upgrading from v4 to v5 (released 2020). If you're on a recent version, see the [v6 migration guide](/docs/faqs#what-do-i-need-to-do-to-migrate-to-v6) instead.
