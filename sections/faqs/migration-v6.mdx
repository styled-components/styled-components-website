...
> v6.3.0+: Native React Server Components (RSC) support was added. Styled components now work in RSC without `'use client'` directives or registry setup. See the [RSC section](/docs/advanced#react-server-components) for details.
