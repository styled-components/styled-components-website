## Migrating to styled-components v6
...
With styled-components v6 utilizing the newer stylis v4, make sure to update any `stylisPlugins` you're providing to StyleSheetManager.
