...
> Vendor prefixing is available but disabled by default in v6+. Enable it via [`StyleSheetManager`](/docs/api#stylesheetmanager) if needed for legacy browser support.
