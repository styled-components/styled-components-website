...
> This style of usage requires React CDN bundles and the [`react-is` CDN bundle](https://unpkg.com/react-is@17/umd/react-is.production.min.js) to be on the page as well (before the styled-components script.) See [React's CDN documentation](https://react.dev/learn/add-react-to-an-existing-project#using-react-for-a-part-of-your-existing-page) for details.
