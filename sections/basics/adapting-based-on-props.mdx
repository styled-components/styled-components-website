...
> **React Server Components (v6.3.0+):** Dynamic interpolations incur serialization overhead in RSC. For discrete variants, prefer data attributes (e.g., `&[data-primary="true"]`) with static styles. See the [RSC section](/docs/advanced#react-server-components) for best practices.
