...
Recommended reading: Talia Marcassa wrote a great review of real-world usage, featuring practical insights and comparisons with alternatives, in [Styled Components: To Use or Not to Use?](https://medium.com/building-crowdriff/styled-components-to-use-or-not-to-use-a6bb4a7ffc21)
